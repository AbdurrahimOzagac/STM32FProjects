...
int main(void)
{
  ...
  /* USER CODE BEGIN WHILE */
    ...
    /* USER CODE BEGIN 3 */
		...
		int8_t err4 = BMP180_Poll(&bmp180_handle);

		int8_t err5 = MPU6050_Get_Inertial_Data(&mpu6050_handle,
				&inertial_data);
		int8_t err6 = QMC5883P_Get_Magnetic_Data(&qmc5883p_handle,
				&magnetic_data);
		int8_t err7 = BMP180_Get_Data(&bmp180_handle, &barometer_data);
