/**
 ******************************************************************************
 * @file    mpu6050_port_stm32f4.c
 * @author  abdurrahimozagac
 * @brief   STM32F4 Specific Port/Wrapper Implementation for MPU6050 Driver
 ******************************************************************************
 */
...
int8_t MPU6050_Port_STM32_Init(MPU6050_Handle_t *handle, I2C_HandleTypeDef *hi2c) {
    ...
    return MPU6050_I2C_Init(handle, stm32_i2c_write, stm32_i2c_read, (void *) hi2c);
}
